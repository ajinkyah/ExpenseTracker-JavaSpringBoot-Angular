...
PreparedStatement s = conn.prepareStatement("select Category, Amount from expenses where ID = ? group by Category");
s.setInt(1, ID);
...
%>
  ...
  <div class= "d-flex justify-content-center">
  		<div class = "col-md-10">
  		<h3><center>CategoryWise Expense made...</center></h3>
  		<table class = "table">
  		<thead>
  			<tr>
