...
PreparedStatement s = conn.prepareStatement("select date_format(Dated, '%Y')as Dated, sum(Amount) as Amount from expenses where ID = ? group by date_format(Dated, '%Y')");
s.setInt(1, ID);
...
%>
  ...
  <div class= "d-flex justify-content-center">
  		<div class = "col-md-10">
  		<h3><center>Yearly Expense made...</center></h3>
  		<table class = "table">
  		<thead>
  			<tr>
